...
- **Browser-only**: Requires interactive browser navigation (CAPTCHAs, login, JavaScript-heavy interfaces)
- **In-person only**: Physical visit or written request required
